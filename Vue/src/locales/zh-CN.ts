...
export default {
  ...
  activeUsersCount: '有效用户 {n}',
  historyOrdersCount: '历史订单 {n}',
  notForSale: '未销售',
  trialAssignmentTitle: '无有效订阅用户的体验套餐',
  trialAssignmentDesc: '无订阅、已过期或流量为 0 的非封禁用户共 {n} 人',
  selectTrialPlan: '选择体验套餐',
  durationMinute: '分钟',
  durationHour: '小时',
  durationDay: '天',
  durationWeek: '周',
  ...
  durationYear: '年',
  durationNoLimit: '不限时',
  msgPlanMappingFailed: '读取套餐映射失败：{err}',
  ...
  modulePlans: '套餐',
  modulePlansDesc: '读取源套餐并映射到目标已有套餐（不创建套餐）',
  moduleOrders: '订单',
  ...
  errors: '错误',
  elapsed: '耗时',
  speedAndEta: '当前阶段速度 / 剩余',
  etaCalculating: '计算中',
  safeCancel: '安全取消',
  cancelPending: '正在等待当前批次完成',
  ...
  msgImportCancelled: '迁移已安全取消，可稍后继续',
  msgCancelRequested: '已请求安全取消',
  msgResumeAvailable: '发现可恢复的迁移任务',
  confirmResumeMigration: '将从上次成功提交的批次继续迁移，原任务的模块和套餐映射会自动恢复。确认继续？',
  confirmStartMigration: '即将按当前映射开始正式迁移。目标已有套餐不会被创建或覆盖，此写入操作不可撤销。确认继续？',
  cancel: '取消',
  close: '关闭',
  realtimeLogs: '实时日志',
  noLogs: '暂无日志',
